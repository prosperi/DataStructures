...
public class AnimalTest{
    ...
    public void setUp()
    {
        ...
        stats.add(10.1);
        stats.add(5.1);
        animal = new Animal("cow", "herbivore", 'c', energySources, energy, stats, 30, 50, 20, 1, 1);
        plant = new Plant("wheat", "vegetable", 'h', energySources, energy, stats, 30, 50, 20, 1, 1);
        strangePlant = new Plant("grapes", "fruit", 'g', energySources, energy, stats, 30, 50, 20, 0, 0);
    ...
    public Plant bulkBanana(int x, int y){
        ...
        return new Plant("banana", "fruit", 'b', energySources, 20.0, stats, 30, 50, 20, x, y);
    }
