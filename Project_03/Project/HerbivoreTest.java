...
public class HerbivoreTest
{
    ...
    public void testEat() {
        ...
        Species testAnimal = new Herbivore("bear", "b", energySources, 10.0, 1.0, 10.0, 10.0, 10.0, 10.0, 10.0, 1.0, 7, 12, 20);
    ...
    public void testChangeHome(){
        ArrayList<String> energySources = new ArrayList<String>();
        energySources.add("wheat");
        Animal testAnimal = new Herbivore("bear", "b", energySources, 10.0, 1.0, 10.0, 10.0, 10.0, 10.0, 10.0, 1.0, 7, 12, 20);
